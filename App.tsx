...
import { Level, Region, ArticleType, ReverseLogisticsMode, BusinessBuffers, Marketplace, Brand } from './types';
...
const App: React.FC = () => {
  ...
  }, [targetSettlement, level, articleType, isReverse, reverseRegion, reverseMode, reversePercent, marketplace, brand, ajioMargin, ajioTradeDiscount]);
      ...
      <div className="max-w-[1200px] mx-auto px-4 py-6">
        <header className="mb-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-black uppercase tracking-tight leading-none text-forest-pine dark:text-forest-mint">Settlement Suite</h1>
